...
- (NSString*)appURL {
	return @"http://dailywallpaperapp.com/";
}
...
- (NSString*)twitterConsumerKey {
    return @"9pBb2Sda1tscE1WSZZD8w"; //daily
    //return @""; //empty
}

- (NSString*)twitterSecret {
    return @"vKtsRlHjUU9k2avzQvhln2TBxjOC6Q3Ph5rEI3JGw"; //daily
	//return @""; //empty
}
// You need to set this if using OAuth, see note above (xAuth users can skip it)
- (NSString*)twitterCallbackUrl {
	//return @"http://twitter.sharekit.com"; //default
	return @"http://dailywallpaperapp.com/"; 
	//return @""; 
}
...
- (UIColor*)barTintForView:(UIViewController*)vc {    
    ...
    NSLog(@"%@", [NSString stringWithFormat:@"barTintForView: %@", NSStringFromClass([vc class])] );
    ...
    if ([NSStringFromClass([vc class]) isEqualToString:@"SHKTextMessage"])
        return RGBA(18, 64, 63, 255);
    
    if ([NSStringFromClass([vc class]) isEqualToString:@"MFMessageComposeViewController"])
        return RGBA(18, 64, 63, 255);
